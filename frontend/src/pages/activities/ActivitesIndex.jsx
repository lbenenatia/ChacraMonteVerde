            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <div className="flex items-center justify-center space-x-2 mb-4">
                  ...
                  <span className="text-accent font-medium">Quality Assured</span>
                </div>
                <h2 className="font-serif text-4xl font-bold text-foreground mb-4">
                  Certifications & Standards
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Our commitment to excellence is reflected in our industry certifications and quality standards.
                </p>
              </div>
          ...
          <section className="py-16 bg-primary text-primary-foreground">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <h2 className="font-serif text-4xl font-bold mb-4">
                Ready to Experience Monte Verde?
              </h2>
              <p className="text-xl mb-8 opacity-90">
                Schedule a consultation to discuss your event needs and explore our amenities in person.
              </p>

  ...
  const benefits = [
    {
      ...
      description: 'Reembolso completo si cancelas con 30 días de anticipación'
    },
    {
      icon: 'Clock',
        ...
        <section className="py-20 bg-gradient-to-br from-primary to-primary/80">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-white/90 mb-8 leading-relaxed">
              Nuestros asesores especializados están listos para ayudarte a encontrar 
              el paquete perfecto y crear un presupuesto personalizado para tu evento.
            </p>
